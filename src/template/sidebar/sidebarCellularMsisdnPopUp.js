...
class CellularWithphone_noDataPopUp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            info: {},
    ...
    weeklySubscribe=()=>{
        ...
        payload.append('phone_no',  this.removeLeadingZero(this.state.info.phone_no));
                    ...
                    <div className="modal-content w-100" style={{ background: 'white' }}>
                        ...
                        <div id="otp-flow" className="slide" data-tag="otp-flow" style={{ display: 'block', padding: '15px' }}>
                            <div className="input-control active" number>
                                <h5 className="mb-2 w-100">Your phoneNo is: <span><b>{info.phone_no}</b></span></h5>
...
export default CellularWithphone_noDataPopUp;