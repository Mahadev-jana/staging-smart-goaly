											...
											{matchList.map((data, key) => (
												<div class="card" style={{
													...
													<div class="top" style={{ padding: "10px" }} onClick={() => this.props.history.push(`/match/details/${data.match_id}`)}>
														...
														(<div class="mid" style={{  }}>
															<span class="score-left badge" style={{backgroundColor:'#1BBC1B'}}>{data.homeTeam_score}</span>
															<span style={{ margin: "0 5px" }}>-</span>
														...
														(<div class="mid">
															...
															<span style={{ margin: "0 5px" }}>-</span>
															<span class="score-right badge" style={{backgroundColor:'#1BBC1B'}}>{data.awayTeam_score}</span>
