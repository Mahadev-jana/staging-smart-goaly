                  ...
                  <div className="matches row">
                    <div className="d-flex j-center">
                      ...
                      >
                        ...
                        <h5 className="mb-0" style={{overflow: "hidden", textOverflow: "ellipsis"}}>{match.homeTeam_name}</h5>
                      </div>
                      ...
                      >
                        ...
                        <h5 className="mb-0" style={{overflow: "hidden", textOverflow: "ellipsis"}}>{match.awayTeam_name}</h5>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="matches row">
                  <div className="d-flex j-center">
                    ...
                    >
                      ...
                      <h5 className="mb-0 notranslate" style={{overflow: "hidden", textOverflow: "ellipsis"}}>{match.homeTeam_name}</h5>
                    </div>
                    <div className="mid mx-2 d-flex flex-column my-auto">
                    <div className="logo" style={{ width: "83px", height: "61px" , background: "white", borderRadius: "53px", padding: "7px 5px", marginBottom: "10px", margin: "auto auto 10px auto" }}>
                        <img style={{ height: "50px" }} src={BASE_URL + match.images} alt="" />
                    ...
                    >
                      ...
                      <h5 className="mb-0 notranslate" style={{overflow: "hidden", textOverflow: "ellipsis"}}>{match.awayTeam_name}</h5>
                    </div>
                  </div>
                </div>
              </div>
